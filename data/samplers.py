...
class RandomIdentitySampler1(sampler.Sampler):
    def __init__(self, data_source, batch_id, batch_image):
        super(RandomIdentitySampler1, self).__init__(data_source)
...
class RandomIdentitySampler2(sampler.Sampler):
    """
    ...
    def __init__(self, data_source, batch_id, batch_image):
        ...
        self.num_instances = batch_image
        self.num_pids_per_batch = batch_id
        self.index_dic = defaultdict(list)
        for index, path in enumerate(self.data_source.imgs):
            pid=data_source.id(path)
